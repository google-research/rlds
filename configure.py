...
_RLDS_BAZELRC_FILENAME = '.rlds.bazelrc'
_RLDS_WORKSPACE_ROOT = ''
_RLDS_BAZELRC = ''


def main():
  global _RLDS_WORKSPACE_ROOT
  global _RLDS_BAZELRC
  ...
  _RLDS_WORKSPACE_ROOT = args.workspace
  _RLDS_BAZELRC = os.path.join(_RLDS_WORKSPACE_ROOT, _RLDS_BAZELRC_FILENAME)
...
def setup_python(environ_cp):
  ...
  with open(
      os.path.join(_RLDS_WORKSPACE_ROOT, 'python_bin_path.sh'),
      'w') as f:
...
def write_to_bazelrc(line):
  with open(_RLDS_BAZELRC, 'a') as f:
    f.write(line + '\n')


def reset_configure_bazelrc():
  """Reset file that contains customized config settings."""
  open(_RLDS_BAZELRC, 'w').close()
